...
<svelte:window bind:scrollY={scrollY} bind:innerHeight></svelte:window>
...
<footer class="container">
	...
	<div class="last_edited" class:hidden={browser ? (scrollY + innerHeight < documentHeight) : true}>
