...
<!--        </div>-->
    ...
    <picture>
        <source type="image/avif" srcset="me-5121.avif">
        <source type="image/webp" srcset="me-5121.webp">
        <img src="me-5121.jpg" alt="Valentin Rogg Profilbild">
    </picture>
</header>
