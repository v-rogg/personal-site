...
import TagList from "../globals/TagList.svelte";
...
<a
	href={url}
	class="{cls} project relative flex h-80 flex-col overflow-hidden bg-white-600 pl-10 pr-10 pt-9 backdrop-blur transition duration-500 hover:shadow-xl sm:rounded-xl"
...
<style lang="postcss">
	...
	.bg-fade {
		box-shadow: 0 0 40px var(--color-white-600);
