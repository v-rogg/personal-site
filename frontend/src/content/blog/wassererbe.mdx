...
previewImageUrl: /files/images/538704fa-b8d7-42ef-a9f3-7fed59c8b500.jpg
---

import Image from "../../components/Blog/Image.astro";
import Video from "../../components/Blog/Video.astro";
import ImageSlider from "../../components/globals/ImageSlider.svelte";
import CodeBlock from "../../components/globals/CodeBlock.svelte";
...
<div class="flex flex-col sm:flex-row justify-evenly items-center">
  <div><img src="/files/images/c08581e8-d9a5-40a6-013b-697482206900.jpg" height={400} alt="Buch: 'Wasser Kunst Augsburg' als Datenquelle" class="w-full h-auto block"/></div>
  <div><img src="/files/images/a750d2bd-d52c-4463-83c0-efb0ceadc500.jpg" height={400} alt="Historische Karten als Datenquelle" class="w-full h-auto block"/></div>
</div>
...
<div class="flex justify-center">
	<ImageSlider
		a="/files/images/381ceb90-74e0-4cbe-5057-41a7f8bcca00.jpg"
		b="/files/images/f5cecf4b-5715-4bc6-77d8-bc1719fcaa00.jpg"
		aAlt="Augsburg 1890"
		bAlt="Augsburg 1989"
	/>
</div>
...
<div class="flex flex-col sm:flex-row justify-evenly items-center">
  <div><img src="/files/images/44e135b6-5e82-440d-db31-19c117c78700.jpg" height={160} alt="Quadrat-Raster Beispiel" class="w-full h-auto max-h-40 block"/></div>
  <div><img src="/files/images/16a76002-85c4-45c0-6e0e-4c2aeffe4500.jpg" height={160} alt="Hexagon-Raster Beispiel" class="w-full h-auto max-h-40 block"/></div>
</div>
...
<div class="flex justify-center">
	<ImageSlider
		a="/files/images/5054d0a4-442c-49d4-9e65-fe2255d6ba00.jpg"
		b="/files/images/f6d6a527-a95e-47cb-b918-872f352dfd00.jpg"
		aAlt="Augsburg 2020"
...
<div class="flex justify-center">
	<div>
		<img
			src="/files/images/bd0012ab-733a-4079-58f8-488cac437700.jpg"
			class="max-h-[280px]"
...
<div class="flex justify-center">
	<ImageSlider
		a="/files/images/18d5c2ca-e8f4-4045-3b25-8278ce7a7100.jpg"
		b="/files/images/ca0381fe-de05-449f-22cd-f453a0f6c400.jpg"
...
<Image
	src="/files/images/1555a52c-13eb-444c-f307-38d714954700.jpg"
...
<div class="flex justify-center">
	<div>
		<img
			src="/files/images/c3fe9a73-d5ad-4d64-c26f-70caab7da300.jpg"
			class="max-h-[500px]"
...
<Image src="/files/images/79d123fb-6d51-494e-6e0f-3a2d35890500.jpg" height="280" alt="Identifizierung der SVG Polygone nach X_Y_Index" />

So ist es möglich, jede Zone und jeden Kanal programmatisch anzusprechen und je nach ausgewähltem Jahr einzufärben:

<div class="py-4">
	<Video src="/files/videos/1aaf130b34078017879407f4dc805175.mp4" title="Wassererbe Animation" />
</div>

Über diese Zuweisung können auch mehrere Zonen für die Erzählung von Geschichten hervorgehoben werden:

<div class="py-4">
	<Video src="/files/videos/3708077f57f3caf022156574acc3f992.mp4" title="Wassererbe Animation" />
</div>
